    ...
    def process_clusters(self, cluster_labels: np.ndarray, memory_data: List[Dict], 
        ...
        try:
            ...
            for label in unique_labels:
                ...
                cluster_memories = [memory_data[i] for i in cluster_indices]
                ...
                cluster = {
                    'id': f"cluster_{label}_{datetime.now().strftime('%Y%m%d')}",
                    'label': label,
    ...
    def calculate_cluster_statistics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'emotion_distribution': dict(emotion_counts),
                'avg_coherence': np.mean([cluster.get('coherence_score', 0) for cluster in self.clusters])
            }
